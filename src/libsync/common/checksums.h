 ...
 *       -> "SHA1:ab124124"
 */
OPENCLOUD_SYNC_EXPORT QByteArray findBestChecksum(const QByteArray &checksums);

class OPENCLOUD_SYNC_EXPORT ChecksumHeader
{
public:
 ...
 * \ingroup libsync
 */
class OPENCLOUD_SYNC_EXPORT ComputeChecksum : public QObject
{
    Q_OBJECT
public:
 ...
 * @ingroup libsync
 */
class OPENCLOUD_SYNC_EXPORT ValidateChecksumHeader : public QObject
{
    Q_OBJECT
public:
